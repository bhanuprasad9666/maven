...
public class HibernateTestServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Question question1=new Question();
		 ...
		 ans1.setPostedBy("prasad");
		 ansList.add(ans1);
		 
		 Answer ans2=new Answer();
		 ans2.setAnswers("Hibernate is based on ORM");
		 ans2.setPostedBy("durga");
		 ansList.add(ans2); 
	    
		register(question1);
		//Question question2=question2Respos
		

		/*
		 * List<Question> qd = session.
		 * 
		 * for(Question question:ansList) {
		 * System.out.println("answerid"+question.getQid());
		 * System.out.println("questionid:"+question.getAnswers()); }
		 */
